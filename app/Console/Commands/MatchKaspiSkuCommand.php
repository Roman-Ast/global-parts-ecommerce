...
class MatchKaspiSkuCommand extends Command
{
    ...
    // ForumAvto (forumauto_lp) реактивирован 2026-09-24 (Роман) — прайс
    // снова регулярно обновляется (свежий прогон 23.09 подтверждён живьём
    // через supplier_offers/kaspi_initial_products), причина отключения
    // от 2026-08-08 ("прайс давно не обновлялся") больше не актуальна.
