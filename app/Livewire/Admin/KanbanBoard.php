...
class KanbanBoard extends Component
{
    ...
    public function render()
    {
        ...
        // именно ПОТОМУ что она обычно работает правильно — как только
        // менеджер отвечает клиенту (сбрасывая "Пора напомнить"), тот же
        // updated_at подбрасывает карточку на самый верх колонки, где она
        // визуально неотличима от карточек, которым реально нужно
        // внимание прямо сейчас. Сортируем по приоритету действия, а не
