...
class LeadStatuses
{
     ...
     * нашего последнего сообщения: КП отправлено, все четыре подпричины
     * "Работы с возражениями" (молчит/дорого/сроки/думает — все по сути
     * тот же смысл "ждём решения клиента") и "Оплата" (Роман явно
     * подтвердил 2026-09-21, что она тоже должна попадать в напоминания).
     */
    const REMINDER_ELIGIBLE_STATUSES = ['offer', 'silent', 'expensive', 'wait', 'pending', 'payment'];
