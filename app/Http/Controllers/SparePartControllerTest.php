    ...
    public function searchRadle(String $brand, String $partnumber)
    {
        ...
        try {
            ...
            foreach ($parts as $part) {
                ...
                // Роман 2026-08-23: сначала отсекали RUS только при
                // ожидании больше 14 дней. Роман 2026-08-27: отсекать RUS
                // целиком, независимо от срока — не только длинные сроки
                // бесполезны на фоне доставки день-в-день/на следующий
                // день, сам склад РФ решили не показывать вообще.
                if ($supplierCode === 'RUS') {
                    continue;
                }
