...
class SparePartController extends Controller
{
    ...
    public function searchPhaeton(String $brand, String $partnumber)
    {
        ...
        $ch = curl_init();
        $resUrl = 'https://api.phaeton.kz/api/Search?Article='.$partnumber.'&Brand='.$brand.'&Sources[0]=1&includeAnalogs=True&UserGuid=9F6414C4-9683-11EF-BBBC-F8F21E092C7D&ApiKey=LnxrDfpQVZz1ncuoI14e';
        $params = [
            'Article' => $partnumber,
            'Brand' => $brand,
            'includeAnalogs' => true,
