    ...
    <div id="search-res-main-wrapper">
        ...
        <div id="search-part-main-container">
                ...
                @if (count($finalArr['searchedNumber']) > 0)
                    @foreach ($finalArr['searchedNumber'] as $searchItem)
                        <div class="requestPartNumberContainer-item">
                            <div class="requestPartNumberContainer-item-entity requestPartNumber-supplier" style="color:{{ $searchItem['supplier_color'] }} 1px 2px 2px">
            ...
            <div id="crossesContainer-on-stock">
                ...
                <div class="requestPartNumberContainer-item">
                    <div class="requestPartNumberContainer-item-entity requestPartNumber-supplier" style="color:{{ $crossItem['supplier_color'] }} 1px 2px 2px">
