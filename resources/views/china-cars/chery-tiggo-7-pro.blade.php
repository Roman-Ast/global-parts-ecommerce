...
@section('title', 'Chery Tiggo 7 Pro')
    ...
    <div id="santafe1821-wrapper" class="container">
        <div id="santafe18-21container">
            <form class="santafe18-21container-item" method="post" action="{{ route('getPart') }}" target="_blank">
                @csrf
                <img src="/images/hyundai/k5-20-23-fr-bumper.png" alt="Chery-tiggo7pro-fr-bumper" class='santafe18-21-item-img'>
                <div class="santafe18-21-item-desc">
                    <i>Передний бампер</i>
                </div>
                <input type="hidden" name="brand" value="Chery">
                <input type="hidden" name="partnumber" value="602001032AADQ">
                <input type="hidden" name="guid" value="602001032AADQ">
            ...
            <div class="" id="main-img-container">
                <img src="/images/chinacars/chery-tiggo7.webp" alt="chery-tiggo7">
            </div>
            <form class="santafe18-21container-item" method="post" action="{{ route('getPart') }}" target="_blank">
                @csrf
            ...
            <form class="santafe18-21container-item" method="post" action="{{ route('getPart') }}" target="_blank">
                ...
                <input type="hidden" name="brand" value="Chery">
                <input type="hidden" name="partnumber" value="605000200AA">
                <input type="hidden" name="guid" value="605000200AA">
                <input type="hidden" name="rossko_need_to_search" value="1">
                <button type="submit" class="btn btn-sm btn-link car-form-btn">Узнать цену</button>
            </form>
            <form class="santafe18-21container-item" method="post" action="{{ route('getPart') }}" target="_blank">
