    ...
    <div id="santafe1821-wrapper" class="container">
        <div id="santafe18-21container">
            <form class="santafe18-21container-item" method="post" action="{{ route('getPart') }}" target="_blank">
                ...
                <input type="hidden" name="guid" value="86510P1010">
            ...
            <form class="santafe18-21container-item" method="post" action="{{ route('getPart') }}" target="_blank">
                ...
                <input type="hidden" name="guid" value="92401P1110">
                <input type="hidden" name="rossko_need_to_search" value="1">
                <button type="submit" class="btn btn-sm btn-link car-form-btn">Узнать цену</button>
            </form>
            <form class="santafe18-21container-item" method="post" action="{{ route('getPart') }}" target="_blank">
                ...
                <input type="hidden" name="guid" value="51712-L1000">
                <input type="hidden" name="rossko_need_to_search" value="1">
                <button type="submit" class="btn btn-sm btn-link car-form-btn">Узнать цену</button>
            </form>
            <form class="santafe18-21container-item" method="post" action="{{ route('getPart') }}" target="_blank">
                ...
                <input type="hidden" name="guid" value="92101P1101">
                <input type="hidden" name="rossko_need_to_search" value="1">
                <button type="submit" class="btn btn-sm btn-link car-form-btn">Узнать цену</button>
            </form>
            <form class="santafe18-21container-item" method="post" action="{{ route('getPart') }}" target="_blank">
                ...
                <input type="hidden" name="guid" value="92403S1500">
                <input type="hidden" name="rossko_need_to_search" value="1">
                <button type="submit" class="btn btn-sm btn-link car-form-btn">Узнать цену</button>
            </form>
            <form class="santafe18-21container-item" method="post" action="{{ route('getPart') }}" target="_blank">
                ...
                <input type="hidden" name="guid" value="58101P0A11">
                <input type="hidden" name="rossko_need_to_search" value="1">
                <button type="submit" class="btn btn-sm btn-link car-form-btn">Узнать цену</button>
            </form>
            <form class="santafe18-21container-item" method="post" action="{{ route('getPart') }}" target="_blank">
                ...
                <input type="hidden" name="guid" value="86350P1050">
                <input type="hidden" name="rossko_need_to_search" value="1">
                <button type="submit" class="btn btn-sm btn-link car-form-btn">Узнать цену</button>
            </form>
            <form class="santafe18-21container-item" method="post" action="{{ route('getPart') }}" target="_blank">
                ...
                <input type="hidden" name="guid" value="51712L1100">
                <input type="hidden" name="rossko_need_to_search" value="1">
                <button type="submit" class="btn btn-sm btn-link car-form-btn">Узнать цену</button>
            </form>
            <form class="santafe18-21container-item" method="post" action="{{ route('getPart') }}" target="_blank">
                ...
                <input type="hidden" name="guid" value="54650P1050">
                <input type="hidden" name="rossko_need_to_search" value="1">
                <button type="submit" class="btn btn-sm btn-link car-form-btn">Узнать цену</button>
            </form>
            <form class="santafe18-21container-item" method="post" action="{{ route('getPart') }}" target="_blank">
                ...
                <input type="hidden" name="guid" value="86512P1000">
                <input type="hidden" name="rossko_need_to_search" value="1">
                <button type="submit" class="btn btn-sm btn-link car-form-btn">Узнать цену</button>
            </form>
            <form class="santafe18-21container-item" method="post" action="{{ route('getPart') }}" target="_blank">
                ...
                <input type="hidden" name="guid" value="86612P1100">
                <input type="hidden" name="rossko_need_to_search" value="1">
                <button type="submit" class="btn btn-sm btn-link car-form-btn">Узнать цену</button>
            </form>
            <form class="santafe18-21container-item" method="post" action="{{ route('getPart') }}" target="_blank">
                ...
                <input type="hidden" name="guid" value="25310P0000">
                <input type="hidden" name="rossko_need_to_search" value="1">
                <button type="submit" class="btn btn-sm btn-link car-form-btn">Узнать цену</button>
            </form>
            <form class="santafe18-21container-item" method="post" action="{{ route('getPart') }}" target="_blank">
                ...
                <input type="hidden" name="guid" value="54500N9000">
                <input type="hidden" name="rossko_need_to_search" value="1">
                <button type="submit" class="btn btn-sm btn-link car-form-btn">Узнать цену</button>
            </form>
            <form class="santafe18-21container-item" method="post" action="{{ route('getPart') }}" target="_blank">
                ...
                <input type="hidden" name="guid" value="86696P1100">
                <input type="hidden" name="rossko_need_to_search" value="1">
                <button type="submit" class="btn btn-sm btn-link car-form-btn">Узнать цену</button>
            </form>
        </div>
